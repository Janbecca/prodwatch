    ...
    <el-skeleton :loading="loading" animated>
      ...
      <template #default>
        <el-descriptions :column="2" border>
          <el-descriptions-item label="项目ID">{{ show(project?.id) }}</el-descriptions-item>
          ...
          <el-descriptions-item label="项目状态">{{ show(project?.status) }}</el-descriptions-item>
          <el-descriptions-item label="刷新方式">{{ show(project?.refresh_mode) }}</el-descriptions-item>
